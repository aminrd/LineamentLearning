...
class prob2map:
    ...
    def doIteration(self, cmap, crange = 5, threshold = 0.8):
        ...
        for i in range(crange):
            ...
            #TODO: First test all neighbour clusters and choose the best one!

            if E1+E2 >= Emerge * threshold:
                if DEBUG_MODE:
                    print("E1 = {} , E2 = {}, Emerge = {}".format(E1, E2, Emerge))
                    print("--- Merged {} and {}".format(cbase, cprim))
                    print("--- Total number of clusters = {}".format(len(np.unique(cmerge))))
    ...
    def runMethod(self, coeff = 0.5, eps = 1, iteration = 100):
        ...
        for t in range(iteration):
            ...
            im.save('./applet_images/cluster/{}_l.png'.format(t))
